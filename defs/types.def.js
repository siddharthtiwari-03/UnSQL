 ...
 * @prop { whereObj } whenThenCondition.when condition that needs to be checked
 ...
 * @prop {object} if
 * @prop {whereObj} if.check checks the condition if it is true or false
 ...
 * @prop {Array<string>} [from.groupBy] (optional) allows to group result based on single (or list of) column(s)
 * @prop {havingObj} [from.having] (optional) allows to perform comparison on the group of records, accepts array of aggregate method wrappers viz. {sum:...}, {avg:...}, {min:...}, {max:...} etc
 * @prop {{[column:string]:('asc'|'desc')}} [from.orderBy] (optional) allows to order result based on single (or list of) column(s)
 * @prop {number} [from.limit] (optional) limits the number of records to be fetched from the database table
 * @prop {number} [from.offset] (optional) determines the starting index for records to be fetched from the database table
